...
case of interval analysis. We then work on non-relational collecting
semantics, an abstract domain where variables are mapped to subsets of
\(\z\) rather than integer intervals. We prove in this case that we
are able to decide the termination of the analyzer.

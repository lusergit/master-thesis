...
We next prove an easy graph-theoretic property which will be helpful in
the sequel. 
...
\begin{proof}
  ...
  assume, without loss of generality, that the maximum is realised
  ...
  Let us now show \eqref{eq:maxmiddlemaxendpppp}. Given
...
\begin{lemma}
  ...
  % 
  %    \sem{\fix{\com}} \rho
  %    & =  \lfp{\lambda \rho'. (\sem{\com} \rho') \sqcup \rho} 

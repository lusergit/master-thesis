...
We can also obsere that a program induces a monotone function in the
concrete domain \(\dom\):
...
\(\sem{\com^*} = \sem{\fix{\com}}\). Inorder to notice this, let
...
\end{definition}
\noindent
In the following chapters we will usually use the sollowing notation

...
restrictions that we will discuss later. In \secref{sec:intervals} we
will talk about the interval domain, with its characterization in
\secref{sub:intervals} and the domain properties in
\secref{sub:intervalsprop}.  Later, in \secref{sec:nonrelational} we
